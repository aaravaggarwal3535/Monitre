    ...
    <>
      ...
      <div className="bg-gray-100 mt-[50px] rounded-lg h-[30vh] w-[120vh] mx-5 md:mx-5 text-center flex flex-col justify-center items-center space-y-4">
        ...
        <p className="px-4 md:px-16">
          ...
          your finances is simple, smart, and stress-free. Track your expenses,
          grow your savings, and make informed investment decisions— all in one
          place. Whether you're planning for the future or optimizing your daily
          spending, Monetre is your ultimate financial companion.
        </p>
      ...
      <div className="px-4 md:px-20 ">
        ...
        <p className="mt-5">
          Long-term or short-term, high-risk or low-risk. Be the kind of investor
          <br /> you want to be.
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-8 mt-8 px-10">
        ...
        <div className="flex flex-col gap-4 md:w-1/2">
          <div className="flex flex-col p-4 border-2 bg-red-400 rounded-lg text-center">
            <h3 className="text-white text-lg font-semibold">Stocks & Intraday</h3>
          </div>
          <div className="flex flex-col p-4 border-2 bg-red-400 rounded-lg text-center">
            <h3 className="text-white text-lg font-semibold">Mutual funds & SIP</h3>
          </div>
          <div className="flex flex-col p-4 border-2 bg-red-400 rounded-lg text-center">
            <h3 className="text-white text-lg font-semibold">Futures & Options</h3>
          </div>
        </div>
